import Request from '../utils/send_request'
import validate from '../utils/validate'
import optionsSchema from '../utils/options_schema'
...
class RestV2 {
  ...
  depositAddresses(options) {
    return this._request.getPrivate('/api/v2/deposit_address', options, optionsSchema.depositAddresses)
  }
